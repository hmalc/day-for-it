...
public struct WaveForecast: Sendable, Equatable, Identifiable {
    ...
    public init(
        ...
        locationID: UUID,
        validFor: ValidityWindow,
        significantHeightM: FieldValue<Double>,
        peakPeriodS: FieldValue<Double>,
        directionDeg: FieldValue<Double>,
        freshness: FreshnessStatus = .unknown,
        provenance: ProvenanceRef
    ) {
        self.id = id
        self.locationID = locationID
        self.validFor = validFor
        self.significantHeightM = significantHeightM
...
public struct WaveObservation: Sendable, Equatable, Identifiable {
    ...
    public var observedAtUTC: Date
    public var significantHeightM: FieldValue<Double>
    public var maximumHeightM: FieldValue<Double>
    public var peakPeriodS: FieldValue<Double>
    public var zeroCrossingPeriodS: FieldValue<Double>
    public var directionDeg: FieldValue<Double>
    ...
    public init(
        ...
        observedAtUTC: Date,
        significantHeightM: FieldValue<Double>,
        maximumHeightM: FieldValue<Double> = FieldValue(value: nil, state: .notProvided),
        peakPeriodS: FieldValue<Double>,
        zeroCrossingPeriodS: FieldValue<Double> = FieldValue(value: nil, state: .notProvided),
        directionDeg: FieldValue<Double>,
        ...
        self.observedAtUTC = observedAtUTC
        self.significantHeightM = significantHeightM
        self.maximumHeightM = maximumHeightM
        self.peakPeriodS = peakPeriodS
        self.zeroCrossingPeriodS = zeroCrossingPeriodS
        self.directionDeg = directionDeg
...
public struct AssessmentInput: Sendable, Equatable {
    ...
    public var observedWindKmh: FieldValue<Double>
    public var observedWindGustKmh: FieldValue<Double>
    public var waveHeightM: FieldValue<Double>
    public var swellHeightM: FieldValue<Double>
    ...
    public init(
        ...
        observedWindGustKmh: FieldValue<Double> = FieldValue(value: nil, state: .notProvided),
